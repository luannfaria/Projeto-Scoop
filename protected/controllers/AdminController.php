...
class AdminController extends CController
{
	...
	*/
	...
	public function actionIndex()
	{
		...
		} else $this->render('dashboard-franchise');
		}
	}
	...
	public function actionCustomPage()
	{
		if (isset($_GET['Do'])) {
			if ($_GET['Do'] == "Add") {
				...
				$data = array();
				if (isset($_GET['id'])) {
					$data = Yii::app()->functions->getCustomPage((int)$_GET['id']);
					if (!$data) {
	...
	public function actionInvoiceUnpaid()
	{
		$this->crumbsTitle = t("Invoice");
		$this->render('invoice-listunpaid');
	}
			...
			switch ($provider['provider']) {
				...
				case "mapbox":
					$cs->registerScriptFile(
						Yii::app()->baseUrl . "/assets/vendor/leaflet/leaflet.js",
						CClientScript::POS_END
					);
	...
	{
		$this->crumbsTitle = Yii::t("default", "Franchise");
		$this->render('franchise-list');
	}
	public function actionFranchiseAdd()
	{


		$this->crumbsTitle = Yii::t("default", "Adicionar Franquia");
		$this->render('franchise-add');
	}
	public function actionDashboardFranchise()
	{


		$this->crumbsTitle = Yii::t("default", "Dashboard");
		$this->render('dashboard-franchise');
	}

	public function actionMerchantFranchise()
	{
		$this->crumbsTitle = Yii::t("default", "Merchant");
		$this->render('merchant-franchise');
	}
	public function actionareafranchise()
	{
		$this->crumbsTitle = Yii::t("default", "Area");
		$this->render('franchise-area');
	}
	public function actionsalesfranchise()
	{
		$this->crumbsTitle = Yii::t("default", "Relatório de vendas");
		$this->render('rpt-merchant-sales-franchise');
	}
	public function actionfranchiseAreaAdd()
	{
		$this->crumbsTitle = Yii::t("default", "Add Area");
		$this->render('franchise-addarea');
	}

	public function actionAllordersFranchise()
	{
		$this->crumbsTitle = t("All Orders");
		$this->render('allorders-franchise');
	}
	public function actionrptsalescity()
	{
		$this->crumbsTitle = t("All Orders");
		$this->render('rpt-salescity');
	}

	/* pagarme */

	public function actionPagarmeSettings()
	{
		$this->crumbsTitle = Yii::t("default", "Pagarme Settings");
		$this->render('pagarme-settings');
	}

	public function actionrptCustomerSales()
	{
		$this->crumbsTitle = Yii::t("default", "Pa");
		$this->render('rptcustomersales');
	}

	public function actionstatistics()
	{
		$this->crumbsTitle = Yii::t("default", "statistics");
		$this->render('statistics');
	}

	public function actionMessage()
	{
		$this->crumbsTitle = Yii::t("default", "Message List");
		if (isset($_GET['Do'])) {
			$this->crumbsTitle = Yii::t("default", "Message Add/Update");
			$this->render('message-merchant-add');
		} else $this->render('message-merchant-list');
	}
}
/*END CONTROLLER*/
