<form class="uk-form uk-form-horizontal forms" id="forms">
  ...
  <ul data-uk-tab="{connect:'#tab-content'}" class="uk-tab uk-active">
    ...
    <li class="<?php echo $provider_selected == "locasms" ? "uk-active" : ""; ?>"><a href="#"><?php echo t("LocaSms") ?></a></li>
  ...
  <ul class="uk-switcher uk-margin " id="tab-content">
    ...
    <li>
      ...
      <div class="uk-form-row">
        ...
        echo CHtml::radioButton(
          'sms_provider',
          $provider_selected == "locasms" ? true : false,
          array(
            'class' => "icheck",
            'value' => 'locasms'
          )
      ...
      <div class="uk-form-row">
        ...
        echo CHtml::textField(
          'locasms_user',
          Yii::app()->functions->getOptionAdmin('locasms_user'),
          array(
            'class' => "uk-form-width-large"
          )
        )
      ...
      <div class="uk-form-row">
        ...
        echo CHtml::textField(
          'locasms_pass',
          Yii::app()->functions->getOptionAdmin('locasms_pass'),
          array(
            'class' => "uk-form-width-large"
          )
        )
