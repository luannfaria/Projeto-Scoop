...
<!--INICIO ALTERAÇAO PARA ESCOLHER OPÇÃO DE MOSTRAR OU NÃO STATUS NO PAINEL DO MERCHANT -->
<div class="uk-form-row">
				<label class="uk-form-label"><?php echo Yii::t("default", "Show status Merchant") ?></label>
				<?php echo CHtml::dropDownList(
					'showstatus',
					isset($data['showstatus']) ? $data['showstatus'] : "",
					(array)Yii::app()->functions->statusShowMerchant(),
					array(
...
<!-- FIM ALTERAÇAO PARA ESCOLHER OPÇÃO DE MOSTRAR OU NÃO STATUS NO PAINEL DO MERCHANT -->
<div class="uk-form-row">
