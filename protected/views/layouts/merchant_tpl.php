...
<script src="<?php echo Yii::app()->request->baseUrl; ?>/assets/vendor/jqplot/plugins/jqplot.PieRenderer.min.js" type="text/javascript"></script>
...
<script type="text/javascript" src="https://rawgit.com/asmsuechan/jquery_push_notification/master/push_notification.js"></script>
</body>
