  ...
  <div class="container">  
    <div class="row top30">
       <div class="inner">
          ...
          <?php echo CHtml::beginForm( Yii::app()->createUrl('store/paypal_init_reg'), 'post',array(
           'id'=>'frm_redirect_payment'
          ));?>
          <?php 
          echo CHtml::hiddenField('reference_id',$my_token);
          if (isset($_GET['renew'])) {
          ...
          <table class="table">
			...
			<tr>
			<td colspan="2">
			<button  type="submit" class="btn"><?php echo t("Pay now")?></button>  
			</td>
			</tr>
			</table>
