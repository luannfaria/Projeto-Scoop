      ...
      <div class="col-md-10 ">
        <div class="box-grey round top-line-green">
          ...
          <form class="forms" id="forms" onsubmit="return false;">
              ...
              <div class="row top10">
                ...
                <div class="col-md-8 ">
                  <?php echo CHtml::textField(
                    ...
                    array(
                      'class' => 'grey-fields full-width abn',
                      'data-validation' => "required"
                    )
                  ) ?>
                </div>
            ...
            <div class="row top10">
              <div class="col-md-3 "><?php echo t("CPF") ?></div>
              <div class="col-md-8 "> <?php echo CHtml::textField(
                                        'cpf',
                                        isset($data['cpf']) ? $data['cpf'] : "",
                                        array(
                                          'class' => 'grey-fields full-width cpf',
                                          'maxlength' => "14",
                                          'minlength' => "11",
                                          'data-validation' => "required"
                                        )
            ...
            <div class="row top10">
              <div class="col-md-3"><?php echo t("Bairro") ?></div>
              <div class="col-md-8"> <?php echo CHtml::textField(
                                        'bairro',
         ...
         <!--   <div class="row top10" style="display:none">
            ...
            <div class="row top10">
              ...
              <div class="col-md-8"> <?php
                                      ...
                                      $size_list = Yii::app()->functions->cidadesList();
                                      echo CHtml::dropDownList('city', isset($data['city_id']) ? $data['city_id'] : "", $size_list, array(
                                        'class' => 'grey-fields full-width',
                                        'data-validation' => "required"
                                      ))
                                      ?> </div>
            ...
            <div class="row top10">
              ...
              <div class="col-md-8">
                <?php echo CHtml::textField(
                  ...
                  array(
                    'class' => 'grey-fields full-width post_code',
                    'data-validation' => "required"
                  )
                ) ?>
              </div>
            ...
            <div class="row top10 invoice_terms_wrap">
              ...
              <div class="col-md-8">
                ...
                echo CHtml::dropDownList(
                  'invoice_terms',
                  '',
                  (array)FunctionsV3::InvoiceTerms(),
                  array(
                    'class' => 'grey-fields full-width',
                    'data-validation' => "required"
                  )
