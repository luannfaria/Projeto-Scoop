...
<form class="uk-form uk-form-horizontal forms" id="forms">
  ...
  <table width="100%">
    <td width="48%" class="new_box_set" style="padding: 8px; border-radius: 4px;">
      <!--Merchant Logo-->
      <div class="uk-form-row">
        <label class="uk-form-label"><?php echo t("Merchant Logo") ?></label>
        <a href="javascript:;" id="sau_merchant_upload_file" class="button uk-button" data-progress="sau_merchant_progress" data-preview="image_preview" data-field="photo">
          <?php echo t("Browse") ?>
        </a>
      </div>
      ...
      <div class="image_preview">
        ...
        if (!empty($image_url)) {
          //	echo '<img src="'.$image_url.'" class="uk-thumbnail" id="logo-config"  />';
          echo '<img src="' . $image_url . '" class="uk-border-rounded" id="logo-small"  />';
      ...
      <div class="uk-form-row">
        ...
        <a href="javascript:;" id="single_uploadfile" class="button uk-button" data-progress="single_uploadfile_progress" data-preview="single_uploadfile_preview" data-field="photo2">
          <?php echo t("Browse") ?>
        </a>
      </div>
    ...
    <td width="2%"></td> <!-- ESPA�O ENTRE BOX -->

    <!-- AVALIA��ES -->
    <td width="20%" class="new_box_set" style="padding: 8px; border-radius: 4px; display:none">
      <h3 class="center top"><?php echo Yii::t("default", "overall average") ?></h3>
      <div class="center">
        ...
        <div class="mycol">
          <p class="small">
            <a href="<?php echo Yii::app()->request->baseUrl; ?>/merchant/review">
              <?php echo $ratings['votes'] . " " . t("Reviews") ?></a>
          </p>
        </div>
    ...
    <td width="49%" class="new_box_set" style="padding: 8px; border-radius: 4px;">
      <!-- CONFIGURA��ES GERAIS -->

      <h3><?php echo Yii::t("default", "Merchant Open/Close") ?></h3>
  ...
  <h3><?php echo Yii::t("default", "Delivery Settings") ?></h3> <!-- CONFIGURA��ES DA ENTREGA -->

  <table width="100%">

    <td class="new_box_set" style="padding: 8px; border-radius: 4px;">

      <h3><?php echo Yii::t("default", "Settings Delivery Estimation") ?></h3>
      ...
      <div class="uk-form-row">
        ...
        echo CHtml::dropDownList(
          ...
          Yii::app()->functions->getOption("merchant_distance_type", $merchant_id),
    ...
    <td class="new_box_set" style="padding: 8px; border-radius: 4px;">
          ...
          <?php if (is_array($extra_charge_start_time) && count($extra_charge_start_time) >= 1) : ?>
            ...
            ?>
              <div class="uk-form-row time_applicable_rows">
                ...
                <?php
                echo CHtml::textField(
                  "extra_charge_start_time[$x_counter]",
                  $valx,
                  array(
                    'style' => 'width:100px',
                    'class' => 'timepick',
                ...
                <?php
                echo CHtml::textField(
                  "extra_charge_end_time[$x_counter]",
      ...
      <h3><?php echo Yii::t("default", "Free Delivery Options") ?></h3>
    ...
    <td class="new_box_set" style="padding: 8px; border-radius: 4px; display:none">

      <h3><?php echo t("Tracking initial estimation") ?></h3>

      <div class="uk-form-row">
        <label class="uk-form-label"><?php echo t("Delivery") ?></label>
        <?php
        echo CHtml::textField('tracking_estimation_delivery1', getOption($merchant_id, 'tracking_estimation_delivery1'), array(
          'placeholder' => Yii::t("default", "in minutes"),
          'class' => "numeric_only"
        ));
        ?>
        <span><?php echo t("To") ?></span>
        <?php
        echo CHtml::textField('tracking_estimation_delivery2', getOption($merchant_id, 'tracking_estimation_delivery2'), array(
          'placeholder' => Yii::t("default", "in minutes"),
          'class' => "numeric_only"
        ));
        ?>
      ...
      <div class="uk-form-row">
        <label class="uk-form-label"><?php echo t("Pickup") ?></label>
        <?php
        echo CHtml::textField('tracking_estimation_pickup1', getOption($merchant_id, 'tracking_estimation_pickup1'), array(
          'placeholder' => Yii::t("default", "in minutes"),
          'class' => "numeric_only"
        ));
        ?>
        <span><?php echo t("To") ?></span>
        <?php
        echo CHtml::textField('tracking_estimation_pickup2', getOption($merchant_id, 'tracking_estimation_pickup2'), array(
          'placeholder' => Yii::t("default", "in minutes"),
          'class' => "numeric_only"
        ));
        ?>
      ...
      <div class="uk-form-row">
        <label class="uk-form-label"><?php echo t("Dinein") ?></label>
        <?php
        echo CHtml::textField('tracking_estimation_dinein1', getOption($merchant_id, 'tracking_estimation_dinein1'), array(
          'placeholder' => Yii::t("default", "in minutes"),
          'class' => "numeric_only"
        ));
        ?>
        <span><?php echo t("To") ?></span>
        <?php
        echo CHtml::textField('tracking_estimation_dinein2', getOption($merchant_id, 'tracking_estimation_dinein2'), array(
          'placeholder' => Yii::t("default", "in minutes"),
          'class' => "numeric_only"
        ));
        ?>
...
<div class="uk-form-row">
  ...
  <?php echo CHtml::dropDownList(
    'merchant_decimal',
    empty($merchant_decimal) ? 2 : $merchant_decimal,
    Yii::app()->functions->decimalPlacesList(),
    array(
      'class' => 'uk-form-width-large',
      'data-validation' => "required"
    )
...
-->
  ...
  <table width="100%">
    <td width="49%" class="new_box_set" style="padding: 8px; border-radius: 4px;">
      <h3><?php echo t("Food Item Options") ?></h3>
      ...
      <div class="uk-form-row">
        ...
        <p class="uk-text-muted">
          ...
          <a target="_blank" href="<?php echo Yii::app()->request->baseUrl . "/menu-" . $merchant_info[0]->restaurant_slug; ?>?preview=true&token=<?php echo md5($merchant_info[0]->password) ?>">
    ...
    <td width="49%" class="new_box_set" style="padding: 8px; border-radius: 4px;">
      ...
      <h3><?php echo t("Two Flavor Options") ?></h3>
      ...
      <div class="uk-form-row">
        ...
        echo CHtml::dropDownList(
          ...
          getOption($merchant_id, 'merchant_two_flavor_option'),
          array(
            1 => t("Highest price"),
  ...
  <?php if (getOptionA('admin_menu_allowed_merchant') == 2) : ?>
    ...
    <div class="uk-form-row">
      ...
      echo CHtml::checkBox(
        ...
        getOption($merchant_id, 'merchant_show_category_image') == 1 ? true : false,
        array(
          'value' => 1,
          'class' => "icheck",
        )
    ...
    <div class="uk-form-row">
      <label class="uk-form-label"><?php echo t("Enabled lazyload") ?></label>
      <?php
      echo CHtml::checkBox(
        'merchant_menu_lazyload',
        getOption($merchant_id, 'merchant_menu_lazyload') == 1 ? true : false,
        array(
          'value' => 1,
          'class' => "icheck",
        )
  ...
  <h3><?php echo Yii::t("default", "Printing Options") ?></h3> <!-- CONFIGURA��ES DA IMPRESS�O -->
  ...
  <div style="display:none">
    <h3><?php echo Yii::t("default", "External Website") ?></h3> <!-- SITE EXTERNO-->
  ...
  <!--MENU OPTIONS SETTINGS FOR MIMIMUN-->

  <h3><?php echo Yii::t("default", "settings for orders value") ?></h3> <!-- TABLE ADE PEDIDO MINIMO -->

  <table width="100%">

    <td class="new_box_set" style="padding: 8px; border-radius: 4px;">

      <h3><?php echo Yii::t("default", "Minimum Order for") ?> <?php echo t("Delivery") ?></h3>
      ...
      <h3><?php echo Yii::t("default", "Maximum Order for") ?> <?php echo t("Delivery") ?></h3>
    ...
    <td class="new_box_set" style="padding: 8px; border-radius: 4px;">
      ...
      <h3><?php echo Yii::t("default", "Minimum Order for") ?> <?php echo t("Pickup") ?></h3>
      ...
      <h3><?php echo Yii::t("default", "Maximum Order for") ?> <?php echo t("Pickup") ?></h3>
    ...
    <td class="new_box_set" style="padding: 8px; border-radius: 4px;">
      ...
      <h3><?php echo Yii::t("default", "Minimum Order for") ?> <?php echo t("Dine in") ?></h3>
      ...
      <h3><?php echo Yii::t("default", "Maximum Order for") ?> <?php echo t("Dine in") ?></h3>
      <div class="uk-form-row">
        <label class="uk-form-label"><?php echo Yii::t("default", "Maximum purchase amount.") ?></label>
        <table>
          <tr>
  ...
  <div class="uk-form-row">
    ...
    ?>
    <?php echo Price_Formatter::$number_format['currency_symbol']; ?>
  </div>
  ...
  <?php if (!FunctionsV3::isMerchantCommission($merchant_id)) : ?>
    <hr>
    <h3><?php echo t("Service fee") ?></h3>
    ...
    <div class="uk-form-row">
      ...
      echo CHtml::textField(
        ...
        getOption($merchant_id, 'merchant_service_fee'),
        array(
          'class' => "numeric_only",
        )
      );
    ...
    <div class="uk-form-row">
      ...
      <?php echo CHtml::checkBox(
        ...
        Yii::app()->functions->getOption("merchant_service_fee_applytax", $merchant_id) == 1 ? true : false,
        array(
          'class' => "icheck",
          'value' => 1
        )
  ...
  <div class="uk-form-row">
    ...
    echo CHtml::telField(
      ...
      getOption($merchant_id, 'website_merchant_time_picker_interval'),
      array(
        'class' => "numeric_only",
  ...
  <div class="floating_action">
    <input type="submit" value="<?php echo Yii::t("default", "Save") ?>" class="uk-button uk-form-width-medium uk-button-success" style="margin-left: 25%">
  </div>
