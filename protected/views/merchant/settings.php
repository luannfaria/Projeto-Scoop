...
<div class="uk-form-row">
  ...
  <?php 
  echo CHtml::checkBox('merchant_menu_lazyload',
  getOption($merchant_id,'merchant_menu_lazyload')==1?true:false,array(
    'value'=>1,
    'class'=>"icheck",
  ));
  ?> 
...
<div class="uk-form-row">
  ...
  <?php   
  echo CHtml::textField('merchant_service_fee',
...
<?php echo CHtml::checkBox('merchant_service_fee_applytax',
