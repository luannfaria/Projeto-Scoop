...
class Functions extends CApplicationComponent
{
	...
	public function generateqrcode($url = '')
	{
		Yii::app()->setImport(array(
			'application.vendor.qrcode.*'
		));
		require_once('init.php');
		$qr = new Mpdf\QrCode\QrCode($url);
		$image = '';
		$output =	new Mpdf\QrCode\Output\Png();
		$imagem = $output->output($qr, 400);
		$image = "<img  src=\"data:image/png;base64," . base64_encode($imagem) . "\">";
		return $image;
	}
	...
	public function merchantMenu()
	{
		...
		$payment_list = array(
			'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "payment-gateway"), 'tag' => 'payment-gateway', 'label' => '<i class="fa fa-usd"></i>' . Yii::t("default", 'Payment Gateway'),

			'itemOptions' => array('class' => ''), 'items' => array(

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "cod"), 'tag' => 'cod', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Cash On delivery"),
					'url' => array('merchant/codsettings')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "ocr"), 'tag' => 'ocr', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Offline Credit Card Payment"),
				...
				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "paypal_v2"), 'tag' => 'paypal_v2', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Paypal V2"),
					'url' => array('merchant/paypal_v2')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "stp"), 'tag' => 'stp', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Stripe"),
				...
				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "mercadopago"), 'tag' => 'mercadopago', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "mercadopago V2"),
					'url' => array('merchant/mercadopago')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "ide"), 'tag' => 'ide', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Sisow"),
					'url' => array('merchant/sisowsettings')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "payu"), 'tag' => 'payu', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "PayUMoney"),
					'url' => array('merchant/payumoneysettings')
				),


				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "pys"), 'tag' => 'pys', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "paysera"),
					'url' => array('merchant/payserasettings')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "pyr"), 'tag' => 'pyr', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Pay On Delivery"),
					'url' => array('merchant/payondelivery')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "bcy"), 'tag' => 'bcy', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Barclaycard"),
					'url' => array('merchant/barclay')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "epy"), 'tag' => 'epy', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "EpayBg"),
					'url' => array('merchant/epagbg')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "atz"), 'tag' => 'atz', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Authorize.net"),
					'url' => array('merchant/authorize')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "obd"), 'tag' => 'obd', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Offline Bank Deposit"),
					'url' => array('merchant/obd')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "obdreceive"), 'tag' => 'obdreceive', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Receive Bank Deposit"),
					'url' => array('merchant/obdreceive')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "btr"), 'tag' => 'btr', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Braintree"),
					'url' => array('merchant/braintreesettings')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "rzr"), 'tag' => 'rzr', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Razorpay"),
					'url' => array('merchant/razor')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "vog"), 'tag' => 'vog', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "voguepay"),
					'url' => array('merchant/voguepay')
				),
				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "pix"), 'tag' => 'pix', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Pix"),
					'url' => array('merchant/pix-settings')
				),
				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "multicard"), 'tag' => 'multicard', 'label' => '<i class="fa fa-credit-card"></i>' . Yii::t("default", "Multicard"),
					'url' => array('merchant/multicard-settings')
				),
		...
		$fax_menu = array(
			'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "fax"), 'tag' => 'fax', 'label' => '<i class="fa fa-fax"></i>' . Yii::t("default", 'Fax'),

			'itemOptions' => array('class' => ''), 'items' => array(

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "faxstats"), 'tag' => 'faxstats', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Stats"),
					'url' => array('merchant/faxstats')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "faxsettings"), 'tag' => 'faxsettings', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Settings"),
					'url' => array('merchant/faxsettings')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "faxpurchase"), 'tag' => 'faxpurchase', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Purchase Fax Credit"),
					'url' => array('merchant/faxpurchase')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "faxpurchasetrans"), 'tag' => 'faxpurchasetrans', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Purchase Credit Transactions"),
		...
		if ($merchant_type == 2) {
			...
			$payment_list = array(
				...
				'itemOptions' => array('class' => ''), 'items' => array(
					array(
						'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "pyr"),
		...
		return array(
			...
			'items' => array(
				...
				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "Home"), 'tag' => "Home", 'label' => '<i class="fa fa-home"></i>' . Yii::t("default", "Home"),
					'url' => array('/merchant/Home')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "DashBoard"), 'tag' => "DashBoard", 'label' => '<i class="fa fa-home"></i>' . Yii::t("default", "Dashboard"),
					'url' => array('/merchant/DashBoard')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "Merchant"), 'tag' => "Merchant", 'label' => '<i class="fa fa-cutlery"></i>' . Yii::t("default", "Merchant Info"),
					'url' => array('/merchant/Merchant')
				),
				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "Qrcode"), 'tag' => 'Qrcode', 'label' => '<i class="fa fa-qrcode"></i>' . Yii::t("default", "Qr Code"),
					'url' => array('merchant/Qrcode')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "Settings"), 'tag' => "Settings", 'label' => '<i class="fa fa-cog"></i>' . Yii::t("default", "Settings"),
					'url' => array('/merchant/Settings')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "tablebooking"), 'tag' => "tablebooking", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Table Booking"),
					'url' => array('/merchant/tablebooking')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "allorder"), 'tag' => "allorder", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "All order"),
					'url' => array('/merchant/allorder')
				),


				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "order_settings"), 'tag' => "order_settings", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Order Time Management"),
					'url' => array('/merchant/order_settings')
				),


				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "orderStatus"), 'tag' => "orderStatus", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Order Status"),
					'url' => array('/merchant/orderStatus')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "CategoryList"), 'tag' => "CategoryList", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Food Category"),
					'url' => array('/merchant/CategoryList')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "category_sked"), 'tag' => "category_sked", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Food Category Scheduler"),
					'url' => array('/merchant/category_sked')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "Size"), 'tag' => "Size", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Size"),
					'url' => array('/merchant/Size')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "AddOnCategory"), 'tag' => "AddOnCategory", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "AddOn Category"),
					'url' => array('/merchant/AddOnCategory')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "AddOnItem"), 'tag' => "AddOnItem", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "AddOn Item"),
					'url' => array('/merchant/AddOnItem')
				),


				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "ingredients"), 'tag' => "ingredients", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Ingredients"),
					'url' => array('/merchant/ingredients')
				),


				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "CookingRef"), 'tag' => "CookingRef", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Cooking Reference"),
					'url' => array('/merchant/CookingRef')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "FoodItem"), 'tag' => "FoodItem", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Food Item"),
					'url' => array('/merchant/FoodItem')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "invoice"), 'tag' => "invoice", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Invoice"),
				...
				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "shippingrate"), 'tag' => "shippingrate", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Delivery Charges Rates"),
					'url' => array('/merchant/shippingrate')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "mintable"), 'tag' => "mintable", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Minimum Order Table"),
					'url' => array('/merchant/mintable')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "offers"), 'tag' => "offers", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Offers"),
					'url' => array('/merchant/offers')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "gallerysettings"), 'tag' => "gallerysettings", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Gallery Settings"),
					'url' => array('/merchant/gallerysettings')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "banner_settings"), 'tag' => "banner_settings", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Banner Settings"),
					'url' => array('/merchant/banner_settings')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "manage_credit_cards"), 'tag' => "manage_credit_cards", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Manage Credit Card"),
					'url' => array('/merchant/manage_credit_cards')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "voucher"), 'tag' => "voucher", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Voucher"),
				...
				/*addon */
				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "addon"), 'tag' => 'addon', 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", 'Addon'),
					'itemOptions' => array('class' => ''), 'items' => array(

						array(
							'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "points_settings"), 'tag' => 'points_settings', 'label' => '<i class="fa fa-paypal"></i>' . t("Loyalty Points Settings"),
							'url' => array('/merchant/points_settings')
						),

						array(
							'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "printer_merchant_panel"), 'tag' => 'printer_merchant_panel', 'label' => '<i class="fa fa-paypal"></i>' . t("Printer Addon"),
							'url' => array('/printer/merchant_panel?lang=' . Yii::app()->language)
						),


						array(
							'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "singleapp"), 'tag' => 'singleapp', 'label' => '<i class="fa fa-paypal"></i>' . t("Single Merchant"),
				...
				// commission
				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "commission"), 'tag' => 'commission', 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", 'Commission'),
					'itemOptions' => array('class' => ''), 'items' => array(

						array(
							'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "statement"), 'tag' => 'statement', 'label' => '<i class="fa fa-paypal"></i>' . t("Statement"),
							'url' => array('merchant/statement')
						),


						array(
							'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "earnings"), 'tag' => 'earnings', 'label' => '<i class="fa fa-paypal"></i>' . t("Earnings"),
							'url' => array('merchant/earnings')
						),

						array(
							'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "withdrawals"), 'tag' => 'withdrawals', 'label' => '<i class="fa fa-paypal"></i>' . t("Withdrawals"),
				...
				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "sms-gateway"), 'tag' => 'sms-gateway', 'label' => '<i class="fa fa-mobile"></i>' . Yii::t("default", 'SMS'),
					'itemOptions' => array('class' => ''), 'items' => array(
						array(
							'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "smsSettings"), 'tag' => 'smsSettings', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "SMS Alert Settings"),
							'url' => array('merchant/smsSettings')
						),
						array(
							'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "smsBroadcast"), 'tag' => 'smsBroadcast', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "SMS BroadCast"),
							'url' => array('merchant/smsBroadcast')
						),
						array(
							'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "purchaseSMS"), 'tag' => 'purchaseSMS', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Purchase SMS Credit"),
							'url' => array('merchant/purchasesms')
						),
						array(
							'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "purchasesmstransaction"), 'tag' => 'purchasesmstransaction', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Purchase Credit Transactions"),
				...
				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "reports"), 'tag' => 'reports', 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", 'Reports'),
					'itemOptions' => array('class' => ''), 'items' => array(
						array(
							'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "salesReport"), 'tag' => 'salesReport', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Sales Report"),
							'url' => array('merchant/salesReport')
						),
						array(
							'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "salesSummaryReport"), 'tag' => 'salesSummaryReport', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Sales Summary Report"),
							'url' => array('merchant/salesSummaryReport')
						),

						array(
							'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "bookingreport"), 'tag' => 'bookingreport', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Booking Summary Report"),
				...
				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "review"), 'tag' => "review", 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Customer reviews"),
					'url' => array('/merchant/review')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "SocialSettings"), 'tag' => "SocialSettings", 'label' => '<i class="fa fa-facebook-square"></i>' . Yii::t("default", "Social Settings"),
					'url' => array('/merchant/SocialSettings')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "AlertSettings"), 'tag' => "AlertSettings", 'label' => '<i class="fa fa-bell"></i>' . Yii::t("default", "Alert Notification"),
					'url' => array('/merchant/AlertSettings')
				),

				array(
					'visible' => FunctionsV3::hasMerchantAccessToMenu($user_access, "user"), 'tag' => "user", 'label' => '<i class="fa fa-users"></i>' . Yii::t("default", "User"),
					'url' => array('/merchant/user')
				),

				array(
					'tag' => "logout", 'label' => '<i class="fa fa-sign-out"></i>' . Yii::t("default", "Logout"),
	...
	public function adminMenu()
	{
		return array(
			...
			'items' => array(
				array(
					'visible' => $this->AA('dashboard'),
					'tag' => "dashboard", 'label' => '<i class="fa fa-home"></i>' . Yii::t("default", "Dashboard"),
					'url' => array('/admin/dashboard')
				),
				array(
					'visible' => $this->AA('statistics'),
					'tag' => "statistics", 'label' => '<i class="fa fa-home"></i>' . Yii::t("default", "statistics"),
					'url' => array('/admin/statistics')
				),
				/**painel franquia */
				array(
					'visible' => $this->AA('franchisemenu'), 'tag' => 'franchisemenu',
					'label' => '<i class="fa fa-plus-circle"></i>' . Yii::t("default", 'Painel Franquia'),
					'itemOptions' => array('class' => ''), 'items' => array(
						array(
							'visible' => $this->AA('dashboardfranchise'),
							'tag' => "dashboardfranchise", 'label' => '<i class="fa fa-cutlery"></i>' . Yii::t("default", "Painel"),
							'url' => array('/admin/dashboardfranchise')
						),
						array(
							'visible' => $this->AA('merchantfranchise'),
							'tag' => "merchantfranchise", 'label' => '<i class="fa fa-cutlery"></i>' . Yii::t("default", "Restaurantes"),
							'url' => array('/admin/merchantfranchise')
						),
						array(
							'visible' => $this->AA('areafranchise'),
							'tag' => "areafranchise", 'label' => '<i class="fa fa-cutlery"></i>' . Yii::t("default", "Bairros"),
							'url' => array('/admin/areafranchise')
						),
						array(
							'visible' => $this->AA('allordersfranchise'),
							'tag' => "allordersfranchise", 'label' => '<i class="fa fa-cutlery"></i>' . Yii::t("default", "Todos Pedidos"),
							'url' => array('/admin/allordersfranchise')
						),
						array(
							'visible' => $this->AA('salesfranchise'),
							'tag' => "salesfranchise", 'label' => '<i class="fa fa-cutlery"></i>' . Yii::t("default", "Relatorio de vendas"),
							'url' => array('/admin/salesfranchise')
						),
					)
				),
				/**painel franquia */
				...
				array(
					'visible' => $this->AA('merchant'),
					'tag' => "merchant", 'label' => '<i class="fa fa-cutlery"></i>' . Yii::t("default", "Merchant List"),
					'url' => array('/admin/merchant')
				),
				array(
					'visible' => $this->AA('franchise'),
					'tag' => "franchise", 'label' => '<i class="fa fa-cutlery"></i>' . Yii::t("default", "Franchise"),
					'url' => array('/admin/franchise')
				),


				array(
					'visible' => $this->AA('sponsoredMerchantList'),
				...
				array(
					'visible' => $this->AA('managelocation'),
				...
				array(
					'visible' => $this->AA('commisionsettings'),
				...
				array(
					'visible' => $this->AA('message'),
					'tag' => "message",
					'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "message"),
					'url' => array('/admin/message')
				),
				array(
					'visible' => $this->AA('invoice'),
					'tag' => "invoice",
					'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", "Invoice"),
					'url' => array('/admin/invoice')
				),
				array(
					'visible' => $this->AA('invoiceunpaid'),
					'tag' => "invoiceunpaid",
					'label' => '<i class="fa fa-barcode"></i>' . Yii::t("default", "Invoice Unpaid"),
					'url' => array('/admin/invoiceunpaid')
				),

				array(
					'visible' => $this->AA('merchantcommission'),
				...
				/**add ons */
				array(
					'visible' => $this->AA('addons'), 'tag' => 'addons',
					'label' => '<i class="fa fa-plus-circle"></i>' . Yii::t("default", 'Add-ons'),
					'itemOptions' => array('class' => ''), 'items' => array(

						array(
							'visible' => $this->AA('addonexport'),
                   ...
                   'url'=>Yii::app()->getBaseUrl(true)."/mobileapp"),*/
						...
						array(
							'visible' => $this->AA('mobileapp'),
							'tag' => 'mobileapp', 'label' => '<i class="fa"></i>' . Yii::t("default", "MobileApp"),
							'url' => Yii::app()->createUrl('/mobileapp?lang=' . Yii::app()->language)
						),

						array(
							'visible' => $this->AA('pointsprogram'),
				...
				array(
				   ...
				   array(
					'visible' => $this->AA('pagarme'),
					'tag' => 'pagarme', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Pagarme"),
					'url' => array('admin/pagarmeSettings')
				),
				   array(
							'visible' => $this->AA('paypal_v2'),
							'tag' => 'paypal_v2', 'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Paypal V2"),
							'url' => array('admin/paypal_v2')
						),

						array(
							'visible' => $this->AA('cardpaymentsettings'),
						...
						array(
							'visible' => $this->AA('stripeSettings'),
				...
				array(
					'visible' => $this->AA('reports'),
					'tag' => 'reports', 'label' => '<i class="fa fa-list-alt"></i>' . Yii::t("default", 'Reports'),
					'itemOptions' => array('class' => ''), 'items' => array(

						array(
							'visible' => $this->AA('rptMerchantReg'), 'tag' => 'rptMerchantReg',
							'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Merchant Registration"),
							'url' => array('admin/rptMerchantReg')
						),

						array(
							'visible' => $this->AA('rptMerchantPayment'), 'tag' => 'rptMerchantPayment',
							'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Merchant Payment"),
							'url' => array('admin/rptMerchantPayment')
						),

						array(
							'visible' => $this->AA('rptMerchanteSales'), 'tag' => 'rptMerchanteSales',
							'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Merchant Sales Report"),
							'url' => array('admin/rptMerchanteSales')
						),

						array(
							'visible' => $this->AA('rptmerchantsalesummary'), 'tag' => 'rptmerchantsalesummary',
							'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Merchant Sales Summary Report"),
							'url' => array('admin/rptmerchantsalesummary')
						),
						array(
							'visible' => $this->AA('rptcustomersales'), 'tag' => 'rptcustomersales',
							'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "Customer Sales"),
							'url' => array('admin/rptCustomerSales')
						),
						array(
							'visible' => $this->AA('rptsalescity'), 'tag' => 'rptsalescity',
							'label' => '<i class="fa fa-paypal"></i>' . Yii::t("default", "City sales"),
							'url' => array('admin/rptsalescity')
						),

						array(
							'visible' => $this->AA('rptbookingsummary'), 'tag' => 'rptbookingsummary',
	...
	public function topMenu()
	{
		...
		return array(
			...
			'items' => array(
				array(
					'visible' => $hide, 'tag' => "signup", 'label' => '<i class="fa fa-user"></i>' . Yii::t("default", "Login & Signup"),
					'url' => $link_sigup, 'itemOptions' => array('class' => $link_sigup_class)
				),
				array(
					'visible' => $enabled_reg, 'tag' => "home", 'label' => '<i class="fa fa-cutlery"></i>' . Yii::t("default", "Restaurant Signup"),
					'url' => array($signup_link)
				),

				array(
					'tag' => "home", 'label' => '<i class="fa fa-search"></i>' . Yii::t("default", "Browse Restaurant"),
					'url' => array('/store/browse')
				),

				array(
					'visible' => $view_map, 'tag' => "home", 'label' => '<i class="fa fa-map-marker"></i>' . Yii::t("default", "View Restaurant by map"),
					'url' => array('/store/map')
				),
			)
		);
	...
	{
		$top_menu[] = array(
			'tag' => "signup", 'label' => '<i class="fa fa-home"></i>' . Yii::t("default", "Home"),
			'url' => array('/store/home')
		);

		$top_menu[] = array(
			'tag' => "home", 'label' => '<i class="fa fa-envelope-o"></i> ' . Yii::t("default", "Contact"),
			...
			foreach ($data as $val) {
				if ($val['is_custom_link'] == 2) {
					...
					if ($val['open_new_tab'] == 2) {
						$top_menu[] = array(
							'tag' => "home", 'label' => '<i class="' . $val['icons'] . '"></i> ' .
	...
	public function navMenu()
	{
		return array(
			...
			'items' => array(
				array(
					'tag' => "signup", 'label' => Yii::t("default", "Home"),
					'url' => array('/store')
				),

				array(
					'tag' => "home", 'label' => Yii::t("default", "How it works"),
					'url' => array('/store/about')
				),

				array(
					'tag' => "home", 'label' => Yii::t("default", "Contact"),
					'url' => array('/store/contact')
				),
	...
	public function socialMenu()
	{
		...
		return array(
			...
			'items' => array(
				array(
					'visible' => $fb, 'tag' => "signup", 'label' => '<i class="fa fa-facebook"></i>&nbsp;',
					'url' => $admin_fb_page, 'linkOptions' => array('target' => "_blank")
				),

				array(
					'visible' => $twiter, 'tag' => "signup", 'label' => '<i class="fa fa-twitter"></i>&nbsp;',
					'url' => $admin_twitter_page, 'linkOptions' => array('target' => "_blank")
				),

				array(
					'visible' => $google, 'tag' => "signup", 'label' => '<i class="fa fa-google-plus"></i>&nbsp;',
	...
	public function addOnItemToArray(
		$json_data = '',
		$multi_option = '',
		$multi_option_val,
			...
			if (is_array($cart_item) && count($cart_item) >= 1) {
				...
				foreach ($cart_item as $key => $val) {
					...
					if (is_array($t) && count($t) >= 1) {
						...
						if (isset($t[1])) {
							$size_words = $t[1];
							$_size_id = isset($t[2]) ? (int)$t[2] : 0;  // inventory new code
						} else $size_words = '';
					}
					...
					if ($res_category = $this->getCategory($val['category_id'])) {
						...
						$htm .= "<p style=\"margin:0;\"><b>" . qTranslate(
					...
					if (is_array($val['sub_item']) && count($val['sub_item']) >= 1) {
						foreach ($val['sub_item'] as $cat_id => $val_sub) {
							...
							foreach ($val_sub as $addon_row => $val_subs) {
								...
								$addon_item_price = (int)$addon_qty * $addon_item_price;
								...
								$htm .= '<div class="b uk-text-muted">' . Price_Formatter::formatNumber($addon_raw_price) . " " . qTranslate(
									$val_subs[2],
									'sub_item_name',
									$addon_name_trans
								) . '</div>';
						...
						if (isset($_SESSION['distance_info'])) {
							if (is_array($_SESSION['distance_info']) && count($_SESSION['distance_info']) >= 1) {
								$delivery_charges = DeliveryTableRate::getDeliveryFee(
									...
									$subtotal,
									$default_fee,
									$_SESSION['distance_info']['distance'],
									$_SESSION['distance_info']['unit']
								);
							}
						}
					}
				...
				if ($has_voucher == TRUE) {
					...
					if ($show_discount == true) :
						$htm .= FunctionsV3::receiptRowTotal(
					...
					$htm .= FunctionsV3::receiptRowTotal(
						Yii::t("default", "Less Voucher") . " " . $voucher_type,
					...
					$htm .= FunctionsV3::receiptRowTotal(
						'Sub Total',
						Price_Formatter::formatNumber($subtotal),
						'',
						'cart_subtotal'
					);
				}
				...
				if (isset($data['tip_enabled'])) {
					if ($data['tip_enabled'] == 2 && $data['tip_percent'] >= 0.0001) {
						...
						$htm .= FunctionsV3::receiptRowTotal(
							t("Tips") . " " . number_format($data['cart_tip_percentage'], $tip_decimal_places) . "%",
				...
				$htm .= CHtml::hiddenField(
					"subtotal_extra_charge",
	...
	// NOVA FUNÇÃO LISTAR STATUS NO PAINEL DO MERCHANT
	public function orderStatusListView($aslist = true)
	{
		$mid = $this->getMerchantID();
		$list = array();
		if ($aslist) {
		...
		//FIM  NOVA FUNÇÃO LISTAR STATUS NO PAINEL DO MERCHANT
			...
			<?php if ($admin_enabled_paypal == "") : ?>
				<div class="uk-form-row">
					<?php echo CHtml::radioButton(
						'payment_opt',
						false,
						array('class' => "icheck payment_option", 'value' => "pyp")
			...
			<?php if ($admin_enabled_card == "") : ?>
				<div class="uk-form-row">
					<?php echo CHtml::radioButton(
						'payment_opt',
						false,
						array('class' => "icheck payment_opt payment_option", 'value' => "ccr")
			...
			<?php if ($enabled_stripe == "yes") : ?>
				<div class="uk-form-row">
					<?php echo CHtml::radioButton(
						'payment_opt',
						false,
						array('class' => "icheck payment_option", 'value' => "stp")
			...
			<?php if ($admin_mercado_enabled == "yes") : ?>
				<div class="uk-form-row">
					<?php echo CHtml::radioButton(
						'payment_opt',
						false,
						array('class' => "icheck payment_option", 'value' => "mcd")
			...
			<?php if ($admin_sisow_enabled == "yes") : ?>
				<div class="uk-form-row">
					<?php echo CHtml::radioButton(
						'payment_opt',
						false,
						array('class' => "icheck payment_option", 'value' => "ide")
			...
			<?php if ($admin_payu_enabled == "yes") : ?>
				<div class="uk-form-row">
					<?php echo CHtml::radioButton(
						'payment_opt',
						false,
						array('class' => "icheck payment_option", 'value' => "payu")
			...
			<?php if ($admin_bankdeposit_enabled == "yes") : ?>
				<div class="uk-form-row">
					<?php echo CHtml::radioButton(
						'payment_opt',
						false,
						array('class' => "icheck payment_option", 'value' => "obd")
			...
			<?php if ($admin_paysera_enabled == "yes") : ?>
				<div class="uk-form-row">
					<?php echo CHtml::radioButton(
						'payment_opt',
						false,
						array('class' => "icheck payment_option", 'value' => "pys")
			...
			<?php if ($admin_enabled_barclay == "yes") : ?>
				<div class="uk-form-row">
					<?php echo CHtml::radioButton(
						'payment_opt',
						false,
						array('class' => "icheck payment_option", 'value' => "bcy")
			...
			<?php if ($admin_enabled_epaybg == "yes") : ?>
				<div class="uk-form-row">
					<?php echo CHtml::radioButton(
						'payment_opt',
						false,
						array('class' => "icheck payment_option", 'value' => "epy")
			...
			<?php if ($admin_enabled_autho == "yes") : ?>
				<div class="uk-form-row">
					<?php echo CHtml::radioButton(
						'payment_opt',
						false,
						array('class' => "icheck payment_option", 'value' => "atz")
...
<?php
	...
	public function SMSnotificationMerchant($merchant_id = '', $order_info = '', $data = '')
	{
		...
		$sms_alert_message = $this->smarty(
			"amount",
			displayPrice(baseCurrency(), normalPrettyPrice($order_info['total_w_tax'])),
			$sms_alert_message
		);
	...
	public function sendSMS($to = '', $message = '', $record_id = '')
	{
		...
		switch ($sms_provider) {
			...
			case "locasms":
				$loca_user = Yii::app()->functions->getOptionAdmin('locasms_user');
				$loca_password = Yii::app()->functions->getOptionAdmin('locasms_pass');
				$locasms = new LocaSMS($loca_user, $loca_password);
				$locasms->enviarSMS("luantestesms","19997291930");
...
dump($loca_user);
			...
			case "hubtel":
				...
				if ($hubtel_res = $Hubtel->sendSMS(
					getOptionA('hubtel_sender'),
					$to,
					$message,
	...
	public function offlineBankDeposit($merchant = '', $data = '')
	{
		...
		if (!empty($tpl)) {
			$tpl = $this->smarty(
				'amount',
				$this->adminCurrencySymbol() . $this->standardPrettyFormat($package_price),
				$tpl
			);
	...
	public function geraPayloadPix($total, $chavepix, $city, $name)
	{
		Yii::app()->setImport(array(
			'application.vendor.pix.*'
		));
		require_once('init.php');
		$obPayload = new App\Pix\Payload();
		$obPayload->setPixKey($chavepix);
		$obPayload->setDescription('Pedido_Scoop');
		$obPayload->setMerchantName($name);
		$obPayload->setMerchantCity($city);
		$obPayload->setAmount(number_format($total, 2, '.', ''));
		$obPayload->setTxid('SCOOPDELIVERY');
		$payloadQrCode =   $obPayload->getPayload();
		return $payloadQrCode;
	}
	public function multiCard($estabelecimento, $empresa, $funcionario, $senha, $total)
	{
		$curl = curl_init();
		$totalpedido = number_format($total, 2, ',', '');
		curl_setopt_array($curl, array(
			CURLOPT_URL => 'http://multicardconvenios.com.br/api/venda',
			...
			CURLOPT_POSTFIELDS => array('estabelecimento' => $estabelecimento, 'empresa' => $empresa, 'funcionario' => $funcionario, 'senha' => $senha, 'valor' => $totalpedido, 'parcelas' => '1'),
		));
		$response = curl_exec($curl);
		curl_close($curl);
		return $response;
	}
	public function cidadesList($aslist = true)
	{
		$list = array();
		if ($aslist) {
			$list[] = Yii::t("default", "Selecione");
		}
		$db_ext = new DbExt;
		$stmt = "SELECT * FROM
    	  {{location_cities}}
	...
	public function getcidade($city_id)
	{
		$db_ext = new DbExt;
		$stmt = "SELECT name,city_id,state_id FROM
		{{location_cities}}
		WHERE
		city_id= " . $city_id . "
		LIMIT 0,1
	...
	public function franchiseList($aslist = true)
	{
		$list = array();
		if ($aslist) {
			$list[] = Yii::t("default", "Please select");
		...
		if ($res = $db_ext->rst($stmt)) {
			foreach ($res as $val) {
				//$list[$val['stats_id']]=ucwords($val['description']);
				$list[$val['id']] = t($val['razao_social']);
			}
			return $list;
		}
		return false;
	}
	public function getFranchiseInfo($admin_id = '')
	{
		$DbExt = new DbExt;
		$stmt = "SELECT * FROM
    	{{franchise}}
    	WHERE
    	id= " . FunctionsV3::q($admin_id) . "
    	LIMIT 0,1
    	";
		if ($res = $DbExt->rst($stmt)) {
			return $res[0];
	...
	/* WIDGTS PAINEL DASHBOARD */

	public function newClientsToday()
	{

		$date_covered_start = date("Y-m-d");
		$date_covered_end = date("Y-m-d");
		$where = "WHERE date_created BETWEEN '$date_covered_start 00:00:00' AND '$date_covered_end 23:59:00' ";
		$db_ext = new DbExt;
		$stmt = "SELECT COUNT(*) as total
			FROM
			{{client}}
	...
	public function ticketMedioToday()
	{
		...
		$where = "WHERE date_created BETWEEN '$date_covered_start 00:00:00' AND '$date_covered_end 23:59:00' ";
		$db_ext = new DbExt;
		$stmt = "SELECT avg(total_w_tax) as media
			FROM
			{{order}}
		$where
			";
		if ($res = $db_ext->rst($stmt)) {
			$valortotal = Price_Formatter::formatNumber($res[0]['media']);
			return $valortotal;
		}
		return 0;
	}

	public function newOrdersToday()
	{
	...
	public function totalOrdersToday()
	{
		...
		$where = "WHERE date_created BETWEEN '$date_covered_start 00:00:00' AND '$date_covered_end 23:59:00' ";
		$db_ext = new DbExt;
		$stmt = "SELECT SUM(total_w_tax) as total
			FROM
			{{order}}
		$where
			";
		if ($res = $db_ext->rst($stmt)) {
			$valortotal = Price_Formatter::formatNumber($res[0]['total']);
			return $valortotal;
		}
		return 0;
	}

	public function ValueVoucherToday()
	{
		$and =	"AND status NOT IN ('" . initialStatus() . "', 'cancelled', 'decline')";
		$date_covered_start = date("Y-m-d");
		$date_covered_end = date("Y-m-d");
		$where = "WHERE date_created BETWEEN '$date_covered_start 00:00:00' AND '$date_covered_end 23:59:00' ";
		$db_ext = new DbExt;
		$stmt = "SELECT SUM(voucher_amount) as total
			FROM
			{{order}}
		$where
		$and
	...
	public function totalVoucherToday()
	{
		$and =	"AND status NOT IN ('" . initialStatus() . "', 'cancelled', 'decline')";
		$date_covered_start = date("Y-m-d");
		$date_covered_end = date("Y-m-d");
		$where = "WHERE date_created BETWEEN '$date_covered_start 00:00:00' AND '$date_covered_end 23:59:00' ";
		$db_ext = new DbExt;
		$stmt = "SELECT COUNT(voucher_amount) as total
			FROM
			{{order}}
			$where
			$and
	...
	public function ticketMedioTodayMerchant($idmerchant)
	{
		$and = "AND merchant_id=$idmerchant";
		$and2 =	"AND status NOT IN ('" . initialStatus() . "', 'cancelled')";
		$date_covered_start = date("Y-m-d");
		$date_covered_end = date("Y-m-d");
		$where = "WHERE date_created BETWEEN '$date_covered_start 00:00:00' AND '$date_covered_end 23:59:00' ";
		$db_ext = new DbExt;
	...
	public function totalOrdersTodayMerchant($idmerchant)
	{
		$and = "AND merchant_id=$idmerchant";
		$and2 =	"AND status NOT IN ('" . initialStatus() . "', 'cancelled', 'decline')";
		$date_covered_start = date("Y-m-d");
		$date_covered_end = date("Y-m-d");
		$where = "WHERE date_created BETWEEN '$date_covered_start 00:00:00' AND '$date_covered_end 23:59:00' ";
		$db_ext = new DbExt;
	...
	public function newOrdersTodayMerchant($idmerchant)
	{
		$and = "AND merchant_id=$idmerchant";
		$and2 =	"AND status NOT IN ('" . initialStatus() . "', 'cancelled', 'decline')";
		$date_covered_start = date("Y-m-d");
	...
	public function canceledOrdersTodayMerchant($idmerchant)
	{
		$and = "AND merchant_id=$idmerchant";
		$and2 =	"AND status ='cancelled'";
		$date_covered_start = date("Y-m-d");
		$date_covered_end = date("Y-m-d");
		$where = "WHERE date_created BETWEEN '$date_covered_start 00:00:00' AND '$date_covered_end 23:59:00' ";
		$db_ext = new DbExt;
	...
	public function totalcanceledOrdersTodayMerchant($idmerchant)
	{
		$and = "AND merchant_id=$idmerchant";
		$and2 =	"AND status ='cancelled'";
		$date_covered_start = date("Y-m-d");
	...
	public function declinedOrdersTodayMerchant($idmerchant)
	{
		$and = "AND merchant_id=$idmerchant";
		$and2 =	"AND status ='decline'";
		$date_covered_start = date("Y-m-d");
		$date_covered_end = date("Y-m-d");
		$where = "WHERE date_created BETWEEN '$date_covered_start 00:00:00' AND '$date_covered_end 23:59:00' ";
		$db_ext = new DbExt;
	...
	public function totaldeclinedOrdersTodayMerchant($idmerchant)
	{
		$and = "AND merchant_id=$idmerchant";
		$and2 =	"AND status ='decline'";
		$date_covered_start = date("Y-m-d");
	...
	public function totalcomissionTodayMerchant($idmerchant)
	{
		$and = "AND merchant_id=$idmerchant";
		$and2 =	"AND status NOT IN ('" . initialStatus() . "', 'cancelled')";
		$date_covered_start = date("Y-m-d");
		...
		$where = "WHERE date_created BETWEEN '$date_covered_start 00:00:00' AND '$date_covered_end 23:59:00' ";
		$db_ext = new DbExt;
		$stmt = "SELECT SUM(total_commission) as total
			FROM
			{{order}}
		$where
		$and
	...
	public function totaldeliveryTodayMerchant($idmerchant)
	{
		$and = "AND merchant_id=$idmerchant";
		$and2 =	"AND status NOT IN ('" . initialStatus() . "', 'cancelled','decline')";
		$date_covered_start = date("Y-m-d");
		...
		$where = "WHERE date_created BETWEEN '$date_covered_start 00:00:00' AND '$date_covered_end 23:59:00' ";
		$db_ext = new DbExt;
		$stmt = "SELECT SUM(delivery_charge) as total
			FROM
			{{order}}
		$where
		$and
	...
	// NOVA FUNÇÃO OPÇAO VISUALIZAR STATUS PAINEL MERCHANT
	public function statusShowMerchant()
	{
		return array(
		 '1'=>Yii::t("default",'Active'),
		 '0'=>Yii::t("default",'Inactive')

		);
	}


	public function ValueVoucherTodayMerchant($idmerchant)
	{
		$and = "AND merchant_id=$idmerchant";
		$and2 =	"AND status NOT IN ('" . initialStatus() . "', 'cancelled', 'decline')";
		$date_covered_start = date("Y-m-d");
	...
	public function totalVoucherTodayMerchant($idmerchant)
	{
		$and = "AND merchant_id=$idmerchant";
		$and2 =	"AND status NOT IN ('" . initialStatus() . "', 'cancelled', 'decline')";
		$and3 = "AND voucher_code NOT IN ('')";
		$date_covered_start = date("Y-m-d");
		$date_covered_end = date("Y-m-d");
		$where = "WHERE date_created BETWEEN '$date_covered_start 00:00:00' AND '$date_covered_end 23:59:00' ";
		$db_ext = new DbExt;
	...
	/*MESSAGE MERCHANT*/
	public function messageMerchant($idmerchant)
	{
		$DbExt = new DbExt;
		$stmt = "SELECT * FROM
    	{{message_merchant}}
